 ...
 * @returns {String}
 */
const addTimes = async function (startTime, endTime) {
  var times = [0, 0, 0]
...
/**
 * Find duration between two string time values (HH:mm:ss) with javascript
 * @param {String} startTime  String time format
 * @param {String} endTime  String time format
 * @returns {String}
 */
const subTimes = async function (startTime, endTime) {
  var times = [0, 0, 0]
  var max = times.length
...
module.exports.subTimes = subTimes;
